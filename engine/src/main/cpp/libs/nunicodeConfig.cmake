...
function(add_vendor_target NAME TYPE)
    ...
    file(STRINGS ${CMAKE_CURRENT_LIST_DIR}/vendor/${NAME}/files.txt FILES)
    foreach(FILE IN LISTS FILES)
        target_sources(${NAME} ${SOURCE_TYPE} "${CMAKE_CURRENT_LIST_DIR}/vendor/${NAME}/${FILE}")
    endforeach()
    target_include_directories(${NAME} ${INCLUDE_TYPE} ${CMAKE_CURRENT_LIST_DIR}/vendor/${NAME}/include)
