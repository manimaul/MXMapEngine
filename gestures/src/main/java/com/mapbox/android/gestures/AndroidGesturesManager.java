  ...
  private void initDefaultThresholds() {
    for (BaseGesture detector : detectors) {
      if (detector instanceof MultiFingerTapGestureDetector) {
        ((MultiFingerGesture) detector).setSpanThresholdResource(com.mapbox.android.gestures.R.dimen.mapbox_defaultMutliFingerSpanThreshold);
      }
      ...
      if (detector instanceof ShoveGestureDetector) {
        ((ShoveGestureDetector) detector).setPixelDeltaThresholdResource(com.mapbox.android.gestures.R.dimen.mapbox_defaultShovePixelThreshold);
      ...
      if (detector instanceof SidewaysShoveGestureDetector) {
        ((SidewaysShoveGestureDetector) detector).setPixelDeltaThresholdResource(
          com.mapbox.android.gestures.R.dimen.mapbox_defaultShovePixelThreshold);
      ...
      if (detector instanceof MultiFingerTapGestureDetector) {
        ((MultiFingerTapGestureDetector) detector).setMultiFingerTapMovementThresholdResource(
          com.mapbox.android.gestures.R.dimen.mapbox_defaultMultiTapMovementThreshold);
