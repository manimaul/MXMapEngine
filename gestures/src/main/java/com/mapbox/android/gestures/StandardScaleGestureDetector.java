...
public class StandardScaleGestureDetector extends
  ...
  void modifyInternalMinSpanValues() throws NoSuchFieldException, IllegalAccessException {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
      minSpanField.set(
        scaleGestureDetector, (int) context.getResources().getDimension(com.mapbox.android.gestures.R.dimen.mapbox_internalScaleMinSpan24));
    } else {
      minSpanField.set(
        scaleGestureDetector, (int) context.getResources().getDimension(com.mapbox.android.gestures.R.dimen.mapbox_internalScaleMinSpan23));
    }
